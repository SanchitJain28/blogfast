      ...
      <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Transform your ideas into engaging, well-structured blog posts with
            the power of artificial intelligence. Create professional content in
            minutes, not hours.
          </p>
        </div>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Creating a good blog requires a balance of valuable content,
                  engaging writing, and proper formatting. Our AI helps you
                  achieve this balance by generating well-structured, meaningful
                ...
                <div className="text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Begin your blogging journey with AI assistance. Create
                      professional, engaging content that your readers will
                      love.
                    </p>
                  </div>
          ...
          <Card className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground border-0">
            <CardContent className="p-8">
              ...
              <p className="text-primary-foreground/90 mb-6 max-w-2xl mx-auto">
                Start creating professional, engaging blog content today. No
                experience required – just your ideas and our AI.
              </p>
