    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-4">🎉 Blog Published Successfully!</h1>

          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Congratulations! Your blog post has been published and is now live. Share it with the world and start
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card>
              ...
              <CardContent>
                ...
                {/* Blog Title */}
                <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-4 leading-tight">{blogData.title}</h2>
                ...
                {/* Blog Content */}
                <div className={showFullPreview ? "" : "max-h-96 overflow-hidden relative"}>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Button
                  ...
                  onClick={() => copyToClipboard(window.location.origin + "/blogs")}
                >
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="secondary">{blogData.publishedAt.toLocaleDateString()}</Badge>
                  </div>
                  <div className="flex justify-between items-center">
        ...
        <div className="text-center mt-16 pt-8 border-t">
          <h3 className="text-2xl font-bold text-foreground mb-4">Ready to Create More Amazing Content?</h3>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Keep the momentum going! Create more engaging blog posts and build your audience with AI-powered content
            creation.
          </p>
